...
pub struct OrganizationCreatedWebhook(pub Organization);
...
mod test {
    ...
    #[test]
    fn it_deserializes_an_organization_created_webhook() {
        ...
        assert_eq!(
            ...
            Webhook {
                ...
                event: WebhookEvent::OrganizationCreated(OrganizationCreatedWebhook(
                    Organization {
